...
[CovidVisualized Methodology Document Appendix](https://github.com/pourmalek/CovidVisualizedMethodology/tree/main/MethodologyDocumentAppendix)
...
[Publisher](https://bmcresnotes.biomedcentral.com/articles/10.1186/s13104-022-06020-4) || [PubMed](https://pubmed.ncbi.nlm.nih.gov/35397567/) || [PDF](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/journal%20articles%2C%20this%20work/Pourmalek%20F%20-%20CovidVisualized%20-%20BMC%20Research%20Notes%202022.pdf) 
...
* Project: CovidVisualized Methodology Documents for [`covir2`](https://github.com/pourmalek/covir2), [`CovidVisualizedCountry`](https://github.com/pourmalek/CovidVisualizedCountry), and [`CovidVisualizedGlobal`](https://github.com/pourmalek/CovidVisualizedGlobal) repositories
...
Accepted for publication in BMC Research Notes for this project: 
 ...
 [PDF](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/Pourmalek%20F%20-%20CovidVisualized-%20Visualized%20compilation%20of%20international%20updating%20models’%20estimates%20of%20COVID-19%20pandemic%20at%20global%20and%20country%20levels%20-%20PREPRINT%20%20Research%20Square%2020210802.pdf)
...
No model is 100% complete, accurate, and valid, and no model is 100% wrong and useless. As described by Vynnycky and White [[10]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references), models identify the essential elements that determine the real-life behaviour of the epidemic (i.e., the model assumptions) and then properly include those elements in the model structure and calculations. If these essential elements are identified and incorporated wisely, then the model may provide realistic predictions. The first three essential elements of the COVID-19 epidemic are (1) under-reporting of deaths and cases [[11-17]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references), (2) asymptomatic transmission [[11, 18-20]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references), and (3) seasonality [[21-23]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references). The foreseeable advent of vaccines and variants shifted the epidemiologic landscape of disease transmission, and hence vaccines and variants belong among the essential elements of the epidemic [[24-25]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references). Including alternate scenarios in the models can be quite illustrative and useful for policymakers about future trends in the epidemic and the potential role of the interventions [[26]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references). The above-mentioned technical characteristics of the models are mentioned in Appendix Table 2. The whole set of models’ characteristics provides a profile of their strengths and weaknesses – that should be considered while examining the predictions by models.  
...
The CovidVisualized tools do not change any outcomes or variables taken from the five international and periodically updated models. Secondary variables are calculated in CovidVisualized tools: (1) Daily deaths and daily cases are calculated from the provided cumulative deaths and cases by JOHN [[27]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references), DELP [[4]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references), and SRIV [[8]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references). (2) Case Fatality Ratios (CFR), and (3) smoothed variables for daily deaths daily cases from JOHN and DELP. Details of [smoothing](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#smoothing) are provided further below. 
...
DayCfrMeRaA00S00V00 "Daily CFR JOHN [[27]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references)" 
...
Smoothed outcomes are useful for visualization when the raw outcomes are jagged because of day-to-day fluctuations and weekend patterns in reporting. This is true for reported daily deaths and reported daily cases (JOHN) [[27]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references). It is also true for predicted daily deaths and predicted daily cases or infections in the time interval before a model update, i.e., when a model is backcating the daily outcomes in the past. 

The DELP model [[4]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references) does not provide smoothed version of predicted daily variables. Therefore, smoothing is performed in CovidVisualized tools. The IHME model [[5]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references) provides smoothed version of predicted daily variables. Their smoothed version of predicted daily variables is used for visualization. The IMPE [[6]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references) and LANL [[7]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references) models do not provide smoothed version of predicted daily variables. However, their raw (non-smoothed) version of daily outcomes is not very jaggy. Therefore, their raw version of daily outcomes is used in the graphs. The SRIV model [[8]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references) does not provide predictions for the past, and their predicted daily outcomes are used in the graphs. Official reports of daily death and daily cases (JOHN) are the prototype of outcomes for which adding the smoothed version is useful for visualization.   
...
A00 JOHN Johns Hopkins [[27]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references)

A01 DELP DELPHI  [[4]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references)

A02 IHME Institute for Health Metrics and Evaluation [[5]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references)

A03 IMPE Imperial College [[6]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references)

A04 LANL Los Alamos National Laboratory [[7]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references)

A05 SRIV Srivastava [[8]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references)
...
[IHME. COVID-19 Results Briefing, The Eastern Mediterranean Region. May 13, 2021](https://www.healthdata.org/sites/default/files/files/Projects/COVID/2021/44567_briefing_Eastern_Mediterranean_Region_16.pdf). Page 19, Projections and scenarios "The model was run on May 12, 2021."
...
All models label their versions within their data files or on their websites, except the IHME model. The first three versions of the IHME have been described in [[2]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references). Since May 2021, they changed their key metric from reported deaths to the total number of COVID-19 deaths [[32]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references). This included estimation of the ratio of the total number of COVID-19 death to reported deaths from COVID-19. Hence, the IHME model is labelled V4, in this work, starting from May 6, 2021.
...
With daily accumulation of official country reports to WHO, curated by the Johns Hopkins University [[27]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references) and other curators, and other data types used in the models, models update their estimations (predictions) on a rather regular basis. The CovidVisualized tools [1-3] use the estimations updates released by the models on a regular basis. To semantically differentiate between what is released by the models and what is performed by the CovidVisualized tools, the latter is labeled “uptake”. Updates belong to the models. Uptakes belong to the CovidVisualized tools. Updates are released by the model creators. Uptakes are added to CovidVisualized tools by its creator.

The two models with the least frequency of periodic updates of estimates are IHME [[5]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references) and IMPE [[6]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references), updated almost weekly and bi-weekly, respectively – until November 2021. After spread of the Omicron variants, these models reduced the frequency of their update releases. Therefore, two sets of arrangements ruled the frequency of performing uptakes in the CovidVisualized tools [[1-3]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references). The first set covered the year 2021: With the release of each update of either of these two models, the whole set of the five included models is updated in all the three CovidVisualized GitHub repositories. The most recent update of each model is used. The conventions for periodical uptake are described in more detail below. Estimates of the LANL model [[7]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references) got updated about every 3-4 days, and DELP [[4]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references) and SRIV [[8]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references) models get updated daily. The second set of arrangements for the frequency of performing uptakes in the CovidVisualized tools started in 2022. Uptakes are performed each week on Friday. Each uptake uses the latest available update of each model.  
...
This is a description of the rule of adding uptakes to CovidVisualized tools [[1-3]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references). The overarching principle for creating uptakes is to create an uptake for each calendar date on which an update is available for either IHME [[5]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references) or IMPE [[6]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references) and using the most recent update for the other study (IMPE or IHME) for that uptake. The rationale for not including every new update by DELP [[4]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references), LANL [[7]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references), or SRIV [[8]](https://github.com/pourmalek/CovidVisualizedMethodology/blob/main/README.md#references) in the overarching principle is that it would lead to too frequent uptakes, which would defy the purpose of gaining new insight with each uptake of the CovidVisualized tools.
