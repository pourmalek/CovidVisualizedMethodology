...
No model is 100% complete, accurate, and valid, and no model is 100% wrong and useless. As described by Vynnycky and White, models identify the essential elements that determine the real-life behaviour of the epidemic (i.e., the model assumptions) and then properly include those elements in the model structure and calculations. If these essential elements are identified and incorporated wisely, then the model may provide realistic predictions [10]. The first three essential elements of the COVID-19 epidemic are (1) under-reporting of deaths and cases [11-17], (2) asymptomatic transmission [11, 18-20], and (3) seasonality [21-23]. The foreseeable advent of vaccines and variants shifted the epidemiologic landscape of disease transmission, and hence vaccines and variants belong among the essential elements of the epidemic [24-25]. Including alternate scenarios in the models can be quite illustrative and useful for policymakers about future trends in the epidemic and the potential role of the interventions [26]. The above-mentioned technical characteristics of the models are mentioned in Appendix Table 2. The whole set of models’ characteristics provides a profile of their strengths and weaknesses – that should be considered while examining the predictions by models.  
<br/><br/>
